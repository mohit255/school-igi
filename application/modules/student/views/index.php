                                ...
                                <div class="row">                  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                              ...
                                              <select class="form-control col-md-7 col-xs-12" id="add_religion" name="religion">
                                ...
                                <div class="row">  
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" id="father_education" name="father_education" >
                                                <option value="">--Select--</option>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" id="father_profession" name="father_profession" >
                                                <option value="">--Select--</option>
                                ...
                                <div class="row">  
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" id="mother_education" name="mother_education" >
                                                <option value="">--Select--</option>
                                                <option value="Doctorate">Doctorate</option>
                                                <option value="Post Graduate">Post Graduate</option>
                                                <option value="Graduate">Graduate</option>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" id="mother_profession" name="mother_profession" >
                                                <option value="">--Select--</option>
                                                <option value="Self Business">Self Business</option>
                                                <option value="Govt. Employee">Govt. Employee</option>
                                                <option value="Private Employee">Private Employee</option>
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" id="previous_class" name="previous_class" >
                                                <option value="">--Select--</option>
                                ...
                                <div class="row">
                                 ...
                                 <div class="col-md-3 col-sm-3 col-xs-12">
                                     <div class="item form-group">
                                        ...
                                        <select class="form-control col-md-7 col-xs-12" id="health_condition" name="health_condition" >
                                            <option value="">--Select--</option>
