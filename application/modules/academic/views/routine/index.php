                           ...
                           <div class="row">
                               <div class="col-sm-6 col-xs-6  col-sm-offset-3 col-xs-offset-3 layout-box">
                                   ...
                                   <div><img  class="logo-identifier" src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $school->logo; ?>" alt="" width="70" /></div>
                                       <h4 style="font-weight:bold; color:black;"><?php echo $school->school_name; ?></h4>
                                       <p style="font-weight:bold; color:black;"><?php echo $school->address; ?></p>
                                       <h4 style="font-weight:bold; color:black;"><?php echo $this->lang->line('class_routine'); ?></h4>
                                       <h4 style="font-weight:bold; color:black;"><?php echo $this->lang->line('class'); ?> - <?php echo $single_class->name; ?></h4>                                
                                   </p>
                               </div>
                           </div>            
                        </div>       
