    ...
    <head>  
       ...
       <!-- ZOOM CSS -->     
        ...
        <?php } ?>
            ...
            <iframe allow="camera; microphone; fullscreen; display-capture; autoplay" src="https://meet.jit.si/Tenth-A-Mathematics" style="height: 100%; width: 100%; border: 0px;"></iframe>
     ...
     <body class="nav-md">      
        ...
        <script type="text/javascript">
            ...
            var meetConfig = {
                ...
                leaveUrl: "<?php echo site_url('academic/liveclass/index/'.$live_class->id); ?>",
                role: parseInt(1, 10)
            };
