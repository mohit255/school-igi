                ...
                <div class="row">                    
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            <div style="font-weight:bold; color:black;"><?php echo $this->lang->line('running_session'); ?>  <span class="required">*</span></div>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            <div style="font-weight:bold; color:black;"><?php echo $this->lang->line('promote_to_session'); ?>  <span class="required">*</span></div>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            <div style="font-weight:bold; color:black;"><?php echo $this->lang->line('current_class'); ?>  <span class="required">*</span></div>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            <div style="font-weight:bold; color:black;"><?php echo $this->lang->line('promote_to_class'); ?>  <span class="required">*</span></div>
